...
if [ "$Cargo" = true ] ; then
    echo 'wfLoadExtension( "Cargo" );' >> /bitnami/mediawiki/LocalSettings.php
	cd /bitnami/mediawiki/extensions
	sudo -Hu bitnami git clone -b REL1_37 https://gerrit.wikimedia.org/r/mediawiki/extensions/Cargo	
fi

if [ "$DynamicPageList3" = true ] ; then
    echo 'wfLoadExtension( "DynamicPageList3" );' >> /bitnami/mediawiki/LocalSettings.php
	cd /bitnami/mediawiki/extensions
	sudo -Hu bitnami git clone https://github.com/Universal-Omega/DynamicPageList3
fi

if [ "$ExternalData" = true ] ; then
    echo 'wfLoadExtension( "ExternalData" );' >> /bitnami/mediawiki/LocalSettings.php
	cd /bitnami/mediawiki/extensions
	sudo -Hu bitnami git clone -b REL1_37 https://gerrit.wikimedia.org/r/mediawiki/extensions/ExternalData
fi

if [ "$LabeledSectionTransclusion" = true ] ; then
    echo 'wfLoadExtension( "LabeledSectionTransclusion" );' >> /bitnami/mediawiki/LocalSettings.php
	cd /bitnami/mediawiki/extensions
	sudo -Hu bitnami git clone -b REL1_37 https://gerrit.wikimedia.org/r/mediawiki/extensions/LabeledSectionTransclusion
fi

if [ "$MagicNoCache" = true ] ; then
    echo 'wfLoadExtension( "MagicNoCache" );' >> /bitnami/mediawiki/LocalSettings.php
	cd /bitnami/mediawiki/extensions
	sudo -Hu bitnami git clone -b REL1_37 https://gerrit.wikimedia.org/r/mediawiki/extensions/MagicNoCache
fi

if [ "$Widgets" = true ] ; then
    echo 'wfLoadExtension( "Widgets" );' >> /bitnami/mediawiki/LocalSettings.php
	cd /bitnami/mediawiki/extensions
	sudo -Hu bitnami git clone -b REL1_37 https://gerrit.wikimedia.org/r/mediawiki/extensions/Widgets.git
	cd /bitnami/mediawiki/extensions/Widgets
	sudo -Hu bitnami composer update --no-dev
fi
