...
Invoke-SSHCommand -Command "wget -O /home/tom42/Desktop/Wikidump/$safetitle.css https://raw.githubusercontent.com/go2tom42/Quagaars/master/$base/$base.css" -SessionId $ssh169 -ShowStandardOutputStream -ShowErrorOutputStream -Timeout 3600
